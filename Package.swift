...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "WidgetSDK",
            url: "https://artifacts.mdp.sportradar.com/apple/native-widgets-core/63bda7d5/release/WidgetSDK-iOS-0.4.7.zip",
            checksum: "fd1bac0a8e3526c341872b2b3f9e0495b3d0670cad4da57be96422c4d994ef7e"
        ),
        .target(
